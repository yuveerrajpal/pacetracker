...
class PaceAdjuster:
    def __init__(self, temp, humidity, uv_index):
        self.temp = temp
    ...
    def dehydration_risk(self, distance_km, pace_seconds):
        ...
        sweat_rate = 0.6 + (self.temp * 0.025) + (self.humidity * 0.008)
...
def main():
    ...
    try:
        ...
        print(f"--- Gurugram Live: {t}°C | {h}% Humidity | UV: {uv} ---")
